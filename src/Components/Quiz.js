    ...
    <div className='Quiz'>
      <h1>{questions[currentQuestion].Q}</h1>
       <div className={btnGroupClasses}>
        <button onClick={() => dealingWithOptions("A")}>{questions[currentQuestion].optionA}</button>
        <button onClick={() => dealingWithOptions("B")}>{questions[currentQuestion].optionB}</button>
        <button onClick={() => dealingWithOptions("C")}>{questions[currentQuestion].optionC}</button>
        <button onClick={() => dealingWithOptions("D")}>{questions[currentQuestion].optionD}</button>
      </div>
